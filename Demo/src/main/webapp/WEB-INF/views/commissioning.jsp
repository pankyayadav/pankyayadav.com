...
<!--     <div class="container1">
	...
	<div class="about1">
		...
		<div>
			<img class ="pageimg" src="resources/image/commissioning.png"><br><br>
			<div class ="para">
			<p>The systematic process of testing a piece of equipment, system, </p>
			<p>or facility to ensure that it performs in line with the design intent.</p>
			<p> and the owner's operating requirements is known as commissioning.</p>
		</div>
		</div>
	</div>
