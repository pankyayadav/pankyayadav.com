...
<!--     <div class="container1">
	...
	<div class="about1">
		...
		<div>
			<img class ="pageimg" src="resources/image/maintenance.png"><br><br>
			<div class="para">
			<p>Electrical maintenance is a service that involves everything from</p>
			<p>installing equipment to inspecting and diagnosing any faults</p>
			<p>with the equipment to servicing and repairing faulty electrical equipment.</p>
		</div>
		</div>
	</div>
